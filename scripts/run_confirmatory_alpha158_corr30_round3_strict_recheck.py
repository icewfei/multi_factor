...
"""
Strict confirmatory recheck for the single passing Alpha158 head-extraction
...
reference from confirmatory shortlist round 2, then applies the same stricter
preregistered validation rule previously used on VSUMD60:
...
ROUND_BASED_ON_ID = "rr_confirmatory_alpha158_head_extraction_shortlist_round2_20260430"
ROUND_ID = "rr_confirmatory_alpha158_corr30_round3_strict_recheck_20260430"
...
CANDIDATE_RUN_ID = "confirmatory_corr30_trainval_20260430"
...
CODE_HASH_FILES = [
    ROOT / "scripts" / "run_confirmatory_alpha158_corr30_round3_strict_recheck.py",
]
...
def main() -> None:
    ...
    write_json(ROUND_DIR / "confirmatory_round3_strict_recheck_results.json", result)
    ...
    (ROUND_DIR / "confirmatory_round3_strict_recheck_results.md").write_text(
        "\n".join(lines).rstrip() + "\n",
        encoding="utf-8",
    )
