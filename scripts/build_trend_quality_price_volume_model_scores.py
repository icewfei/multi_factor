...
"""
Build a reproducible trend-quality price/volume model_scores_D0.parquet.

This is the minimal v14 builder. It:
- reads the project-owned sample panel
- derives a fixed trend-quality price/volume feature set from shared bars data
...
DEFAULT_CANDIDATE_SCHEME_ID = "trend_quality_price_volume_v14_core"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build trend-quality price/volume model_scores_D0.parquet."
    )
...
def main() -> None:
        ...
        con.execute(
            ...
            COPY (
                WITH score_frame AS (
                    ...
                    LEFT JOIN trend_consistency_ranks t
                      ON f.snapshot_id = t.snapshot_id
                     AND f.instrument = t.instrument
    ...
    audit = {
        ...
        "feature_family": "trend_quality_price_volume_core_v1",
        ...
        "summary_counts": {
            ...
            "momentum_rank_rows": int(audit_counts[5] or 0),
            "lowvol_rank_rows": int(audit_counts[6] or 0),
            "liquidity_rank_rows": int(audit_counts[7] or 0),
            "trend_consistency_rank_rows": int(audit_counts[8] or 0),
        },
        "notes": [
            "This minimal v14 builder uses only directionally aligned price/volume-derived market features from D0-and-earlier data.",
