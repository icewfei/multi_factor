...
"""
Run round11b canonical batch03: exact qlib Alpha158 features 61-90,
...
ROUND_ID = "rr_price_volume_single_signal_discovery_v18_round11b_canonical_batch03_20260428"
AS_OF_DATE = "20260428"
...
SCORE_BUILDER_NAME = "run_round11b_canonical_batch03_single_signal_batch.py"


FEATURE_BATCH = build_feature_batch(start_slot=61, count=30)
...
def main() -> None:
    run_single_signal_batch(
        ...
        round_label="Round-11b-Canonical-Batch03",
        ...
        positive_reason=(
            "Canonical batch03 produced at least one clean positive exact-Alpha158 keeper, but controller policy still "
            "blocks family reopening and requires continued serial-only canonical execution."
        ),
        zero_reason=(
            "Canonical batch03 produced zero clean positive keepers; continue serial-only exact Alpha158 discovery and "
            "do not reopen family construction."
        ),
        summary_intro=(
            "This batch is the third exact qlib Alpha158 canonical execution tranche under round11b governance. "
            "All 30 features are implemented independently on the project's own adjusted-price daily-bar contracts."
        ),
        round_note_prefix="Round11b canonical batch03 serial run completed under exact Alpha158 governance.",
    )
