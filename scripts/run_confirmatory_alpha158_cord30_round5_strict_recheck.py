...
"""
Strict confirmatory recheck for the single passing Alpha158 higher-invested-weight
head-extraction candidate price_volume_single_signal_alpha158_cord30_v1.

This round does not rebuild strategy artifacts. It freezes the candidate and the
reference from confirmatory shortlist round 4, then applies the same stricter
preregistered validation rule previously used on VSUMD60 and CORR30.
"""
...
ROUND_BASED_ON_ID = "rr_confirmatory_alpha158_high_invested_weight_head_extraction_shortlist_round4_20260430"
ROUND_ID = "rr_confirmatory_alpha158_cord30_round5_strict_recheck_20260430"
ROUND_DIR = ROOT / "artifacts" / "research_registry" / "research_rounds" / ROUND_ID
FIXED_TEST_DIR = ROOT / "artifacts" / "fixed_test"

REFERENCE_RUN_ID = "confirmatory_reference_v18_trainval_20260429"
CANDIDATE_RUN_ID = "confirmatory_cord30_trainval_20260430_round4"
...
CODE_HASH_FILES = [
    ROOT / "scripts" / "run_confirmatory_alpha158_cord30_round5_strict_recheck.py",
]
...
def main() -> None:
    ...
    perturbation_deltas: dict[int, dict] = {}
    for topk in (8, 12):
    ...
    result = {
        ...
        "based_on_round_id": ROUND_BASED_ON_ID,
    ...
    write_json(ROUND_DIR / "confirmatory_round5_strict_recheck_results.json", result)
    ...
    (ROUND_DIR / "confirmatory_round5_strict_recheck_results.md").write_text(
        "\n".join(lines).rstrip() + "\n",
        encoding="utf-8",
    )
